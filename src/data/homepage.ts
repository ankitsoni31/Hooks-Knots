...
export const reviews: Review[] = [
  ...
  },
  {
    ...
    avatar: "MJ",
    rating: 5,
    text: "I've ordered from many crochet shops but Hooks & Knots is on another level. The quality, packaging, and communication were all top-notch!",
...
export const shop = [
  ...
  { name: "New Arrivals", href: "/shop#featured" },
];
export const customerService = [
  { name: "FAQ", href: "/contact#faq" },
  { name: "Shipping Info", href: "/contact#faq" },
  { name: "Return Policy", href: "/contact#faq" },
  { name: "Custom Orders", href: "/custom-orders" },
...
export const allProducts: Product[] = Array.from(new Map([...featuredProducts, ...bestSellers].map(item => [item.id, item])).values());